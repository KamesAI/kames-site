      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-12">
          ...
          <aside className="md:col-span-1 space-y-2">
            ...
            <a href="#notre-demarche" className="hover:text-primary">Notre démarche</a>
            <a href="#securite" className="hover:text-primary">Sécurité et Authentification</a>
            <a href="#agents-ia" className="hover:text-primary">Agents IA</a>
            <a href="#api" className="hover:text-primary">Référence API</a>
            <a href="#best-practices" className="hover:text-primary">Meilleures pratiques</a>
          </aside>

          {/* Contenu principal */}
          <div className="md:col-span-3">
            <h3 id="introduction" className="text-3xl font-bold mb-4">Introduction</h3>
            <p className="text-muted-foreground mb-4">
              ...
              artificielle peuvent <span className="text-foreground">simplifier votre travail au quotidien</span>.
            </p>
            <p className="text-muted-foreground mb-4">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              fonctionnent ces systèmes et comment nous les adaptons à votre entreprise.
            </p>
