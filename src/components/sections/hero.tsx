...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative hero-wrap flex w-full items-center justify-center overflow-hidden"
    >
      {/* Image de fond */}
      {heroImage && (
        <Image
      ...
      {/* Overlay sombre équilibré */}
      <div className="hero-overlay" />

      {/* Bande dégradée ORANGE au tout sommet (remplace le violet) */}
      <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#FF6D00]/30 via-transparent to-transparent" />

      <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        {/* (SUPPRIMÉ) Kames AI Studio */}

        {/* Titre principal plus aéré (comme ta photo 3) */}
        <h1 className="mt-2 text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight md:leading-[1.05]">
        ...
        {/* Bloc “Nous ne sommes pas…” avec phrase ANIMÉE sur 1 LIGNE */}
        ...
        {/* Bouton rond discret pour descendre vers Services */}
        <div className="mt-10">
