  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        headline: ['Product Sans', 'sans-serif'],
        code: ['monospace'],
      },
      colors: {
      ...
      keyframes: {
        ...
        // Chrome ring rotation for scroll button
        'chrome-spin': {
      ...
      animation: {
        ...
        'overlay-fade-out': 'overlay-fade-out 1s ease-out forwards',
        ...
        // Chrome ring animations
        'chrome-spin': 'chrome-spin 3.5s linear infinite',
        'chrome-spin-slow': 'chrome-spin 4s linear infinite',
